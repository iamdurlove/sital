...
<body>
      ...
      <div class="nav-bar">
        <div class="brand">
          <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> SITAL'S</h1><span class="sr-only"></span>
          </a>
        </div>
        <div class="nav-list">
          <div class="hamburger">
  ...
  <section id="hero" style="position: relative;">
    ...
    <div class="hero container" style="position: relative; z-index: 1;">
      <div>
        <h1><strong>
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> SITAL</h1><span></span>
          </strong></h1>
        <h1><strong style="color:white;">COTTAGE & RESTAURANT<span></span></strong></h1>
        ...
        <div class="mainDish">
          ...
          <?php foreach ($mainDishes as $item) : ?>
            <p>
              ...
              <span class="item-price">NPR<?php echo $item['item_price']; ?></span><br>
  ...
  <div class=" about container">
    <div class="col-right">
      ...
      <h2>Sital Cottage & Restaurant Company History</h2>
      <p>Sital Cottage & Restaurant is a well-established Western food establishment in the city's heart. Sital Cottage & Restaurant has become a popular choice for customers looking to celebrate special occasions or simply enjoy a relaxing meal, with a focus on providing delicious meals and a friendly dining experience.
      </p>
      <p>Sital Cottage & Restaurant, as a Western restaurant, offers a diverse menu that caters to a variety of tastes. The menu includes a wide range of options such as bar bites, salads, soups and a variety of main courses. Customers can savour succulent options such as steak and ribs, chicken, lamb, seafood, burgers and sandwiches, pasta, and a variety of delectable side dishes. The menu has been carefully curated to offer a balance of classic favourites and innovative creations, ensuring that every palate is satisfied.
      </p>
      <p>Sital Cottage & Restaurant's ability to accommodate customers is one of its distinguishing features. Sital Cottage & Restaurant strives to create an inviting and comfortable dining environment, whether guests prefer to walk in or make reservations in advance. The restaurant recognises the significance of creating memorable experiences, particularly for those celebrating special occasions. Sital Cottage & Restaurant is a popular choice for families, couples, and groups of friends because of its attentive staff and welcoming atmosphere.
      </p>
      <p>Sital Cottage & Restaurant has an inviting outdoor bar that is open seven days a week from 11:00 AM to 10:00 PM in addition to the indoor dining area.This outdoor space provides a relaxed setting for patrons to unwind and socialise while sipping on their favourite drinks and nibbling on bar bites. The bar serves a wide range of beverages, including cocktails, wines, beers and non-alcoholic options.
      </p>
    ...
    <div class="contact-items">
      ...
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          ...
          <h1>Address</h1>
          <h2>Belbas-12, JhalungePool, Butwal, 32900</h2>
        </div>
      </div>
    </div>
    </div>
  ...
  <section id="footer">
    <div class="brand">
      <img src="../../RestaurantProjectImages/footer.jpeg" alt="img">
    </div>
    ...
    <h1 style="text-align: center; color:white; background: red; padding: 1% 0; ">© 2023-<?php echo date('Y') ?> Sital Cottage & Restaurant</h1>
