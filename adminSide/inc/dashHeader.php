...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        if ($staff_role == "Chef")
            echo <<<link
                <a class="navbar-brand ps-3" href="../panel/kitchen-panel.php">Sital's Staff Panel || $staff_role </a>
            link;
        else
            echo <<<link
                <a class="navbar-brand ps-3" href="../panel/pos-panel.php">Sital's Staff Panel || $staff_role </a>
            link;
        ?>
